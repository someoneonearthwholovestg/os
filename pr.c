...
This program implements **priority scheduling** for processes in C (non-preemptive). Higher priority number means higher priority. It calculates **start time, completion time, turnaround time, waiting time, response time** and averages.
